...
@XmlSeeAlso({
    GetTableEntryDescriptionReply.class,
    GetTableEntryListReply.class,
    UpdateTableEntryReply.class,
    BizOpsSessionStartReply.class,
    GetTableEntryDataReply.class,
    AddTableEntryReply.class,
    GetTableEntryLookupInfoReply.class,
    GetTableEntryIDReply.class,
    DeleteTableEntryReply.class
})
