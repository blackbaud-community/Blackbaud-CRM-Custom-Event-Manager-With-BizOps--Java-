...
@XmlSeeAlso({
    GetTableEntryDataRequest.class,
    AddTableEntryRequest.class,
    GetTableEntryIDRequest.class,
    DeleteTableEntryRequest.class,
    GetTableEntryLookupInfoRequest.class,
    GetTableEntryDescriptionRequest.class,
    UpdateTableEntryRequest.class,
    GetTableEntryListRequest.class
})
