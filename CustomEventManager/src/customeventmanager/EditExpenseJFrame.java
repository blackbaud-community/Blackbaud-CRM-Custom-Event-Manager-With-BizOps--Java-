...
public class EditExpenseJFrame extends javax.swing.JFrame {
    static EventExpenseEditRecordOperation.RecordData expenseData;
   ...
   public void getVendors() throws JAXBException, IOException{
    ...
    public EditExpenseJFrame(EventExpenseEditRecordOperation.RecordData exDa, String exId, String dbToUse) throws JAXBException, IOException {
        databaseToUse = dbToUse;
        initComponents();
        setConstituentsTableModelColumns();
        expenseData = exDa;
        expenseId = exId;
        jFormattedTextFieldBudgetedAmount.setText(expenseData.getBUDGETEDAMOUNT().toString());
        jTextAreaComment.setText(expenseData.getCOMMENT());
        jFormattedTextFieldAmountPaid.setText(expenseData.getAMOUNTPAID().toString());
        jLabelConstituentVendorId.setText(expenseData.getVENDORID().toString());
        jLabelEventExpenseId.setText(expenseId);
        jComboBoxType.setSelectedItem(jLabelVendorId);
        //jLabelEventId.setText(expenseData.toString());
        //jLabelEventName.setText(expenseData.get.toString());
        jLabelVendorId.setText(expenseData.getVENDORID().toString());
        jTextFieldVendor.setText(getVendorSingle(jLabelVendorId.getText()));
        ...
        jLabelTypeId.setText(expenseData.getEVENTEXPENSETYPECODEID());
        for (EventExpenseType.TableEntryListRow i : typeList) {
            if (i.getID().equals(jLabelTypeId.getText())) {
                    System.out.println(i.getDescription());
                    jComboBoxType.setSelectedItem(i.getDescription());
                }
            };
...
private void jButtonSaveExpenseMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButtonSaveExpenseMouseClicked
        try {
            // TODO add your handling code here:
                editExpense(expenseData, expenseId);
